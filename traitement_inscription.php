    ...
    <div id="wrapper">
        ...
        <div id="header">
                <div id="barreheader">
                    ...
                    <a href="inscription.html" class="lienh" STYLE="text-decoration: underline">S'inscrire</a> | 
    ...
    if (isset($_POST["bouffon"])){
        if ($db_found) {
            ...
            elseif ($type == "V") {
                ...
                else{echo "L'email joint est déjà relatif à un membre de notre base de données. Veuillez en saisir un nouveau s'il vous plait. <a href='inscription.html'> Cliquez sur ce lien";}
            }
        }
    }
