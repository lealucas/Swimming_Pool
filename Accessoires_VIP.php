    ...
    <div id="wrapper">
        ...
        <div id="nav">
            ...
            <ul id="menuNav">
                ...
                <a href="toutParcourir.html" class="lienn"STYLE="text-decoration: underline">Tout Parcourir</a>
            ...
            <div id="categorie">
                ...
                <div id="content">
                    <ul id="choixliste">
                        ...
                        <a href="Accessoires_VIP.php" class="lienc" STYLE="text-decoration: underline">Accessoires VIP</a><br><br><br>
